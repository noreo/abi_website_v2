...
export function Tarif() {
  return (
      <FadeInOnScroll>
    <section
      className="bg-background relative overflow-visible px-[0px] py-16"
      id="Tarif"
    >
        <div className="max-w-[1320px] mx-auto px-4 md:px-8 text-center overflow-visible">
          <div className="w-full bg-dark rounded-[16px] p-6 md:p-9 lg:p-16 relative border shadow-sm overflow-visible">
